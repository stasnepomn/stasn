  ...
  return (
    <>
      ...
      <div className='max-w-screen-lg mx-auto break-words p-5 pt-5 md:pt-10'>
        <a className='hover:opacity-70 transition block p-10 mb-10 bg-white rounded-lg text-center font-bold underline text-2xl select-none border-2' href='https://mailchi.mp/getkit.news/peace'>нет войне</a>
